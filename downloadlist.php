		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="container">
					...
					<h2><strong>Csattack</strong> Choose From Courses</h2>
					<!--
					<div class="row">
						<div class="col-md-12">
							<p class="lead">
				...
				<!--	<h3 class="short"><strong>Downloads</strong> Our Tutorial</h3><br> -->
					...
					<div class="row">
						<?php 
							 					$query1="select * from quiz_subject_name WHERE course_name='CS Foundation'";
                                                  $result1=mysql_query($query1);
                                                 $foundation=mysql_num_rows($result1);
                                                 $query2="select * from quiz_subject_name WHERE course_name='CS Executive'";
                                                  $result2=mysql_query($query2);
                                                 $executive=mysql_num_rows($result2);
                                                 $query3="select * from quiz_subject_name WHERE course_name='CS Professional'";
                                                  $result3=mysql_query($query3);
                                                 $professional=mysql_num_rows($result3);
						...
						<div class="pricing-table">
							<div class="col-md-3 col-sm-6"  style="margin-left:20px;">
								<div class="plan">
									<h3>CS FOUNDATION<span>FREE</span></h3>
									<a class="btn btn-lg btn-primary" href="./download_cs_foundation.php">Download</a>
									<ul>
										<li><b><?php echo $foundation;?></b> Subjects</li>
										
									</ul>
								</div>
							</div>
						<div class="col-md-3 col-sm-6"  style="margin-left:120px;">
								<div class="plan">
									<h3>CS EXECUTIVE<span>FREE</span></h3>
									<a class="btn btn-lg btn-primary" href="./download_cs_executive.php">Download</a>
									<ul>
										<li><b><?php echo $executive;?></b> Subjects</li>
							...
							<div class="col-md-3 col-sm-6"  style="margin-left:120px;">
								<div class="plan">
									<h3>CS PROFESSIONAL<span>FREE</span></h3>
									<a class="btn btn-lg btn-primary" href="./download_cs_professional.php">Download</a>
									<ul>
										<li><b><?php echo $professional;?></b> Subjects</li>
