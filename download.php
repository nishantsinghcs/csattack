		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="container">
					...
					<h2><strong>Csattack</strong> Complete Package Price Table</h2>
					...
					<div class="row">
						...
						<div class="pricing-table">
							<div class="col-md-3 col-sm-6">
								<div class="plan">
									<h3>Free Edition<span>Rs.0</span></h3>
									<a class="btn btn-lg btn-primary" href="./downloadlist.php">Download</a>
									<ul>
										<li><b>Limited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
									</ul>
								</div>
							...
							<div class="col-md-3 col-sm-6 center">
								<div class="plan most-popular">
									...
									<h3>Professional<span>Rs.2900</span></h3>
									<a class="btn btn-lg btn-primary" href="#">Download</a>
									<ul>
										<li><b>Unlimited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
									</ul>
								</div>
							...
							<div class="col-md-3 col-sm-6">
								<div class="plan">
									<h3>Standard<span>Rs.2000</span></h3>
									<a class="btn btn-lg btn-primary" href="#">Download</a>
									<ul>
										<li><b>Unlimited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
					...
					<h2><strong>Csattack</strong> Complete Package Price Courses Wise</h2>
					...
					<div class="row">
						...
						<div class="pricing-table">
							<div class="col-md-4">
								<div class="plan">
									<h3>Cs Executive<span>Rs.500</span></h3>
									<a class="btn btn-lg btn-primary" href="#">Downloads</a>
									<ul>
										<li><b>Unlimited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
							...
							<div class="col-md-4">
								<div class="plan">
									<h3>Cs Foundation<span>Rs.400</span></h3>
									<a class="btn btn-lg btn-primary" href="#">Downloads</a>
									<ul>
										<li><b>Unlimited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
							...
							<div class="col-md-4">
								<div class="plan">
									<h3>Cs Professional<span>Rs.900</span></h3>
									<a class="btn btn-lg btn-primary" href="#">Downloads</a>
									<ul>
										<li><b>Unlimited</b> Chapter</li>
										<li><b>Limited</b> Chapter</li>
