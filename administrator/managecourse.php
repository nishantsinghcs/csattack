            ...
            <form name="mngstate" id="mngstate" method="post" action="">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?=output($data->course_name)?></td>
                  <td><?php echo ($data->course_prt_id	 == '0') ? 'Main Course' : 'Sub Course';?></td>
                  <td><?=output($data->course_updated_on) ?></td>
                  <td><?=$data->course_status?></td>
                  <td>
                    
                    <a href="editcourse.php?id=<?=$data->course_id?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a> <a href="managecourse.php?id=<?=$data->course_id?>&action=del" title="Delete" onClick="return confirm('Sure you want to delete this Course');"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td>
                </tr>
                <?php } }else{ ?>
                <tr>
