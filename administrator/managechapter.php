...
$sql = "select * from quiz_chapter_name";		
        ...
        <div class="tab-content default-tab" id="tab1"> 
          ...
          <div class="notification success png_bg"> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
            <div>
              ...
              else if($_GET['msg']=="notdeleted")

              {

                echo "Kindly delete all releted questions first !!";
            ...
            <form name="mngstate" id="mngstate" method="post" action="">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?=output($data->chapter_name)?></td>
                  <td><?php echo ($data->subject_name);?></td>
                  <td><?=output($data->time) ?></td>
                  
                  <td>
                    
                 <a href="managechapter.php?id=<?=$data->chapter_name?>&action=del" title="Delete" onClick="return confirm('Sure you want to delete this Chapter');"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td>
                </tr>
                <?php } }else{ ?>
                <tr>
