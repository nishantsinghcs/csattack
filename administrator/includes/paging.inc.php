	  ...
	  */	   
...

      {
        ...
        elseif($this->show_first_last && $this->show_disabled_links)
            ...
            echo ' <a href="javascript:void(0);">'.$user_link.'</a> ';
...

      {
        ...
        if($this->page>$this->scroll_page &&$this->show_scroll_prev_next)
            ...
            echo ' <a href="'.$this->page_name.'?page='.($this->page-$this->scroll_page).$this->qry_str.'" '.$link_para.' class="text-link">'.$user_link.'</a> ';
...

      {
...

        {
         ...
         if($i==$this->page)
            ...
            echo '<a href="javascript:void(0);" class="number current" >'.($i+1).'</a>';

         else

            echo '<a href="'.$this->page_name.'?page='.$i.$this->qry_str.'" '.$link_para.' class="number">'.($i+1).'</a> ';

        }

		if(($j+$scroll_page) <= $this->total_page-1)
