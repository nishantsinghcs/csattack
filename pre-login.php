									...
									<ul class="dropdown-menu">
										...
										<div style="width:450px;margin-left:30%">
														...
														<div class="signin-form">
															...
															<strong style="background:green; color:white;padding:5px;">You have been registered Susessfully 
															 <img src="./img/tick.png" style="height:10px;width:10px;"></strong><br><br>
															 <strong style="background:green; color:red;padding:5px;">Now go to your email to verify and activate account.</strong>
															<br><br><br>
															<span class="mega-menu-sub-title">Sign In</span>
															...
															<p class="sign-up-info">Don't have an account yet? <a href="./signin.php" id="">Sign Up!</a></p>
